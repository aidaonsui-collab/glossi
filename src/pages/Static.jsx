  ...
  return (
    <Shell>
      ...
      <Body>
        ...
        <p>{t('Salons set their own prices, hours, and service area. Glossi takes 5% of each confirmed booking. Salons are responsible for their own licensing, insurance, and tax obligations. Glossi is not an employer.', 'Los salones fijan sus propios precios, horarios y área de servicio. Glossi toma el 5% de cada reserva confirmada. Los salones son responsables de sus propias licencias, seguros y obligaciones fiscales. Glossi no es un empleador.')}</p>
