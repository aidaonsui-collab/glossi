...
export default function Marketing() {
  ...
  return (
    <div style={{ background: p.bg, minHeight: '100vh', color: p.ink, fontFamily: type.body }}>
      ...
      <div style={{ padding: isPhone ? '36px 18px' : '90px 64px 70px', borderTop: `0.5px solid ${p.line}` }}>
        <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.18em', color: p.inkMuted }}>
          {t('CUSTOMER ACQUISITION', 'ADQUISICIÓN DE CLIENTES')}
        </div>
        <h2 style={{ fontFamily: type.display, fontStyle: 'italic', fontSize: isPhone ? 30 : 50, fontWeight: type.displayWeight, letterSpacing: '-0.025em', lineHeight: 1, margin: '10px 0 0', textWrap: 'balance' }}>
          {t('The cheapest customer is the one who asked for you.', 'El cliente más barato es el que te pidió a ti.')}
        </h2>
        <p style={{ fontSize: isPhone ? 14 : 16, color: p.inkSoft, lineHeight: 1.55, margin: '14px 0 0', maxWidth: 620 }}>
          {t(
        ...
        <div style={{ marginTop: isPhone ? 22 : 38 }}>
          {!isPhone && (
          ...
          {[
            ...
            <div key={r.name} style={{
              ...
              gap: isPhone ? 8 : 16,
              alignItems: 'center',
              padding: isPhone ? '16px 18px' : '18px',
              ...
              <div style={{
                ...
                fontSize: isPhone ? 20 : 22, fontWeight: type.displayWeight,
                letterSpacing: '-0.01em',
                color: r.highlight ? p.accent : p.ink,
              }}>{r.name}</div>
              <div style={{ fontSize: isPhone ? 13 : 14, color: r.highlight ? 'rgba(255,255,255,0.78)' : p.inkSoft, lineHeight: 1.4 }}>{r.how}</div>
              <div>
                <span style={{
        ...
        <div style={{ marginTop: isPhone ? 26 : 36, fontFamily: type.display, fontStyle: 'italic', fontSize: isPhone ? 22 : 30, fontWeight: type.displayWeight, color: p.ink, letterSpacing: '-0.02em', lineHeight: 1.1, textWrap: 'balance', maxWidth: 720 }}>
