...
const COPY = {
  en: {
    ...
    hero_h: ['They come', 'to you.'],
    hero_sub: 'Clients in the Valley post what they need. You send a price. You fill your chair with the bookings you actually want. No chasing leads.',
  ...
  es: {
    ...
    hero_h: ['Ellos vienen', 'a ti.'],
    hero_sub: 'Las clientas del Valle publican lo que necesitan. Tú envías tu precio. Llenas tu silla solo con las citas que te convienen. Sin perseguir contactos.',
