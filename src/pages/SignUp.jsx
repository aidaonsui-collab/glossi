        ...
        <div style={{ padding: isPhone ? '32px 18px 48px' : '64px 80px', display: 'flex', flexDirection: 'column', justifyContent: 'center', maxWidth: 600 }}>
          ...
          <form onSubmit={submit} style={{ marginTop: 22, display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginTop: 8, cursor: 'pointer' }}>
              <span onClick={() => setAgree(v => !v)} style={{
              ...
              <span style={{ fontSize: 12.5, color: p.inkSoft, lineHeight: 1.55 }}>
                I agree to Glossi's <span style={{ color: p.ink, textDecoration: 'underline', fontWeight: 600 }}>Terms of Service</span> and <span style={{ color: p.ink, textDecoration: 'underline', fontWeight: 600 }}>Privacy Policy</span>. Glossi may send appointment reminders and bid updates by email and SMS — you can opt out anytime in settings.
              </span>
            </label>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
              {[
                ...
                <button key={s.id} type="button" onClick={() => toast(`${s.l} sign-up — coming soon. Use email for now.`)} style={{
